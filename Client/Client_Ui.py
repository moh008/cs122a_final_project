...
""))
        ...
        #---------------------------------------------------------
        self.Btn_Mode5 = QtGui.QRadioButton(Client)
        self.Btn_Mode5.setGeometry(QtCore.QRect(240, 550, 90, 30))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("3ds"))
        font.setPointSize(10)
        self.Btn_Mode5.setFont(font)
        self.Btn_Mode5.setObjectName(_fromUtf8("Btn_Mode5"))
        #---------------------------------------------------------
    ...
    def retranslateUi(self, Client):
        ...
        #--------------------------------------------------------------
        self.Btn_Mode5.setText(_translate("Client", "Nodrill", None))
        #--------------------------------------------------------------